...
Namespace DragDropColumns
    ...
    Partial Public Class MainWindow
        ...
        Public Sub New()
            ...
            AddHandler gridControl1.Columns.CollectionChanged, AddressOf Columns_CollectionChanged
        End Sub

        Private Sub Columns_CollectionChanged(ByVal sender As Object, ByVal e As System.Collections.Specialized.NotifyCollectionChangedEventArgs)
